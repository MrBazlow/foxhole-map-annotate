    ...
    <Popover className="relative">
      <Popover.Button className="group mx-2 flex items-center overflow-hidden rounded-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-warden-500 active:scale-95">
        <img
          width="40"
          height="40"
          className="rounded-lg transition duration-200 group-hover:scale-110 group-hover:brightness-125 group-active:scale-110"
          src="/images/placeholder_profile.webp"
          alt="Profile"
        />
      </Popover.Button>
      <Popover.Panel className="absolute right-0 mt-4 w-fit origin-top-right divide-y divide-zinc-500 overflow-hidden rounded-lg bg-zinc-800 shadow-lg">
